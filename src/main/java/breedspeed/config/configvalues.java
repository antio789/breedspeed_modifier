...
public class configvalues {
        ...
        public static class Change_Durations {
            ...
            public static boolean animal_breeding_on = !COMMON.breeding_on.get();
            public static boolean villager_breeding_on = !COMMON.villager_breeding_on.get();
            //@Config.RangeInt(min=1,max=300)
            ...
            public static int Minspawndelay = COMMON.Minspawndelay.get();
            public static int Maxspawndelay = COMMON.Maxspawndelay.get();

            public static int getMinspawndelay() {
                return Minspawndelay*20;
            }

            public static int getMaxspawndelay() {
                return Maxspawndelay*20;
            }
