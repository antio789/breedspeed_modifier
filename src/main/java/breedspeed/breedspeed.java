...
public class breedspeed
{
    ...
    public final String modid="customspeed";
    ...
    @SubscribeEvent
    public void spawnerspawned(LivingSpawnEvent.SpecialSpawn event){
        if (event.getSpawner()!=null) {
            CompoundNBT nbt = new CompoundNBT();
            event.getSpawner().write(nbt);
            nbt.putShort("MinSpawnDelay", (short)getMinspawndelay());
            nbt.putShort("MaxSpawnDelay", (short)getMaxspawndelay());
    ...
    public void breedevent(BabyEntitySpawnEvent event){
        ...
        if(event.getParentA() instanceof VillagerEntity){
            event.setCanceled(villager_breeding_on);
            ...
            event.setCanceled(animal_breeding_on);
            event.getParentA().addTag(Updatetag);
            event.getParentB().addTag(Updatetag);
            if(event.getChild()!=null)
            event.getChild().addTag(Updatetag);
